const SUPPORT_TG = "https://t.me/Amit_Supportt";
        ...
        items: [
            {
                ...
                a: {
                    ru: `Тебе нужно запустить бота и нажать на “ПОЛУЧИТЬ СИГНАЛ”, пройти регистрацию и пополнить аккаунт на любую сумму.<p>Запустить бота → <a href="https://t.me/gridi_aitrading_bot?=start" target="_blank" rel="noreferrer">нажми сюда</a></p>`,
                    en: `You need to launch the bot and click on “GET SIGNAL”, register, and top up your account with any amount.<p>Launch the bot → <a href="https://t.me/gridi_aitrading_bot?=start" target="_blank" rel="noreferrer">click here</a></p>`
                }
            },
            {
                id: "have-account",
